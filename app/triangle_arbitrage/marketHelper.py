...
import app.triangle_arbitrage.exchangeConnection.huobi.huobiService
import app.triangle_arbitrage.exchangeConnection.bitex.bitexService
import app.triangle_arbitrage.exchangeConnection.pro.proService
