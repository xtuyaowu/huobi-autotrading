...
import app.triangle_arbitrage.utils.helper as uh
# 包装一个不同市场的统一接口 方便同一套套利
from app.triangle_arbitrage.exchangeConnection.bitex import bitexService
from app.triangle_arbitrage.exchangeConnection.huobi import huobiService
from app.triangle_arbitrage.exchangeConnection.pro import proService
        ...
        if self.market_name == "huobi":
            ...
            if quote_cur == "cny":
                if base_cur == "eth" or base_cur=="etc":
                    bitex_acc = bitexService.BitexServiceAPIKey(key_index="CNY_1").get_spot_acct_info()
                    if cur_name == "eth":
                    ...
                    account_info = huobiService.getAccountInfo("cny", "get_account_info")
                ...
                # 内测
                pro_acc = proService.ProServiceAPIKey(key_index="CNY_1").get_spot_acct_info()
                if cur_name == "btc":
        ...
        if self.market_name == "huobi":
            ...
            if quote_cur == "cny":
                if base_cur == "eth":
                    ...
                    return huobiService.buy(1, price, amount, None, None, "cny", "buy")
                elif base_cur == "ltc":
                    return huobiService.buy(2, price, amount, None, None, "cny", "buy")
            elif quote_cur == "btc":
                if base_cur == "eth":
        ...
        if self.market_name == "huobi":
            ...
            if quote_cur == "cny":
                if base_cur == "eth":
                    ...
                    return huobiService.sell(1, price, amount, None, None, "cny", "sell")
                elif base_cur == "ltc":
                    return huobiService.sell(2, price, amount, None, None, "cny", "sell")
            elif quote_cur == "btc":
                if base_cur == "ltc":
                    return proService.ProServiceAPIKey(key_index="CNY_1") \
        ...
        if self.market_name == "huobi":
            ...
            if quote_cur == "cny":
                if base_cur == "eth":
                    ...
                    return huobiService.buyMarket(1, amount, None, None, "cny", "buy_market")
                elif base_cur == "ltc":
                    return huobiService.buy(2, amount, None, None, "cny", "buy_market")
            elif quote_cur == "btc":
                if base_cur == "eth":
                    return proService.ProServiceAPIKey(key_index="CNY_1")\
        ...
        if self.market_name == "huobi":
            ...
            if quote_cur == "cny":
                if base_cur == "eth":
                    ...
                    return huobiService.buyMarket(1, amount, None, None, "cny", "sell_market")
                elif base_cur == "ltc":
                    return huobiService.buy(2, amount, None, None, "cny", "sell_market")
            elif quote_cur == "btc":
                if base_cur == "ltc":
                    return proService.ProServiceAPIKey(key_index="CNY_1") \
        ...
        if self.market_name == "huobi":
            ...
            if quote_cur == "cny":
                if base_cur == "eth":
                    ...
                    result = huobiService.getOrderInfo(
        ...
        if self.market_name == "huobi":
            ...
            if quote_cur == "cny":
                if base_cur == "eth":
                    ...
                    return huobiService.cancelOrder(
                ...
                if base_cur == "ltc" or base_cur == "eth" or base_cur =="etc":
                    return proService.ProServiceAPIKey(key_index="CNY_1").cancel_order(
...
# print(proService.ProServiceAPIKey().get_depth("ethcny").get("tick"))
# print("以太币账户：",bitexService.BitexServiceAPIKey(key_index="CNY_1").get_spot_acct_info())
# print("以太币可用", huobi.account_available("cny", "eth_cny"))
# print(huobiService.getAccountInfo("cny", "get_account_info"))
# print(proService.ProServiceAPIKey(key_index="CNY_1").get_spot_acct_info())
# result = huobiService.buy(2, 320.90, 0.4, None, None, "cny", "buy")
# print(result)
# {'result': 'success', 'id': 4491600137}
# result = huobiService.cancelOrder(1,4491600137, "cny", "cancel_order")
# print(result)
# print(huobiService.getOrderInfo(1, result.get("id"), "cny", "order_info"))
...
# result = huobiService.buyMarket(1, 2000, None, None, "cny", "buy_market")
# print(result)
# 买入eth
# result = bitexService.BitexServiceAPIKey(
...
# print(bitexService.BitexServiceAPIKey(key_index="CNY_1").get_order_info(result.get("data")))
# print("eth order:", bitexService.BitexServiceAPIKey(key_index="CNY_1").get_active_orders("ethcny"))
# print("eth cancel order:", bitexService.BitexServiceAPIKey(key_index="CNY_1").cancel_order("2705970"))
# result = bitexService.BitexServiceAPIKey(
...
#pro
# print(proService.ProServiceAPIKey(key_index="CNY_1").get_spot_acct_info())
# print(proService.ProServiceAPIKey(key_index="CNY_1")\
...
# print(proService.ProServiceAPIKey(key_index="CNY_1").cancel_order(order_result.get("data")))
# order_result = {'status': 'ok', 'data': '3075505'}
# print(bitexService.BitexServiceAPIKey(
