...
# BROKER_URL = 'http://dawn-broker.test.huobiapps.com'
# BROKER_URL = 'http://dawn-broker.prod-bitex.huobi.com'
BROKER_URL = 'http://be.huobi.com'
MARKET_URL = 'http://be.huobi.com'
# BROKER_URL = 'http://dawn-broker-bitex.test.huobiapps.com'
# MARKET_URL = 'http://dawn-notification-peer-bitex.test.huobiapps.com'
# MARKET_URL = 'http://dawn-notification-peer.test.huobiapps.com'
...
def api_key_get(params, request_path, key_index="CNY_1"):
    method = 'GET'
    ACCESS_KEY = accountConfig.BITEX[key_index]["ACCESS_KEY"]
    SECRET_KEY = accountConfig.BITEX[key_index]["SECRET_KEY"]
